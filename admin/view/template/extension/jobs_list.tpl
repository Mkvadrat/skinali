        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-module" class="form-horizontal">
          <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover">
			  ...
			  <tbody>
				<?php if ($all_posts) { ?>
				  <?php foreach ($all_posts as $jobs) { ?>
				  <tr>
					<td width="1" style="text-align: center;"><input type="checkbox" name="selected[]" value="<?php echo $jobs['jobs_id']; ?>" /></td>
					<td class="text-left"><a href="<?php echo $jobs['edit']; ?>"><?php echo $jobs['title']; ?></a></td>
					<td class="text-left"><?php echo $jobs['date_added']; ?></td>
					<td class="text-right"><a href="<?php echo $jobs['edit']; ?>"><?php echo $text_edit; ?></a></td>
				  </tr>
				  <?php } ?>
				<?php } else { ?>
				  <tr>
