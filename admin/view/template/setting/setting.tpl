        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="store-language<?php echo $language['language_id']; ?>">
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-comment<?php echo $language['language_id']; ?>">Информация о продукции:</label>
                      <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-header-text">Контактная информация в шапке сайта:</label>
                  <div class="col-sm-10">
                    <textarea name="config_header_text" rows="5" placeholder="Контактная информация в шапке сайта:" id="input-header-text" class="form-control"><?php echo $config_header_text; ?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-instagram">Социальные сети (Инстаграмм):</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_instagram" value="<?php echo $config_instagram; ?>" placeholder="Социальные сети (Инстаграмм):" id="input-instagram" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-facebook">Социальные сети (Facebook):</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_facebook" value="<?php echo $config_facebook; ?>" placeholder="Социальные сети (Facebook):" id="input-facebook" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-contact-inf">Контактная информация в подвале сайта:</label>
                  <div class="col-sm-10">
                    <textarea name="config_contact_inf" rows="5" placeholder="Контактная информация в подвале сайта:" id="input-contact-inf" class="form-control"><?php echo $config_contact_inf; ?></textarea>
                  </div>
                </div>
                <div class="form-group">
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-logo-footer">Логотип в подвале сайта:</label>
