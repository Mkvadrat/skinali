<?php
// HTTP
define('HTTP_SERVER', 'http://skinali.3331141.xeovo.ml/admin/');
define('HTTP_CATALOG', 'http://skinali.3331141.xeovo.ml/');

// HTTPS
define('HTTPS_SERVER', 'http://skinali.3331141.xeovo.ml/admin/');
define('HTTPS_CATALOG', 'http://skinali.3331141.xeovo.ml/');
