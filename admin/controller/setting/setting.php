...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
      ...
      $this->request->post['config_address'] = $this->request->post['config_langdata'][$front_language_id]['comment'];
		...
		if (isset($this->request->post['config_header_text'])) {
			$data['config_header_text'] = $this->request->post['config_header_text'];
		} else {
			$data['config_header_text'] = $this->config->get('config_header_text');
		}
		...
		if (isset($this->request->post['config_contact_inf'])) {
			$data['config_contact_inf'] = $this->request->post['config_contact_inf'];
		} else {
